...
export default function ParrainagePage() {
  ...
  const whatsappMsg = encodeURIComponent(`Salut ! Je t'invite à utiliser Suivi Dépenses, une app gratuite pour gérer les finances de ta famille 💰\n\n${appUrl}`)
  const smsMsg = encodeURIComponent(`Essaie Suivi Dépenses pour gérer ton budget familial : ${appUrl}`)
    ...
    <main className="max-w-lg mx-auto px-4 py-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 text-sm mt-2">
          Partagez Suivi Dépenses avec vos proches et aidez-les à mieux gérer leurs finances.
        </p>
      </div>
      ...
      <div className="card text-center">
        ...
        <p className="text-gray-600 text-sm">
          Plus vous partagez, plus votre famille et vos amis pourront mieux gérer leur budget. C'est gratuit pour tout le monde !
        </p>
      </div>
    </main>
  )
